...
Magali version compatibility
-----------------------------

Magali uses `semantic versioning <https://semver.org/>`__ (i.e.,
...
Magali follows the recommendations in
...
24 months** before a release with a minimum of 2 minor releases.
...
If you require support for older Python versions, please pin to the following
releases to ensure compatibility:
